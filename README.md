...
I tried to write as much comments as possible, because this can help you understand the configuration. If you still don't understand anything, please let me know! This can be done under the [Discussions](https://github.com/TyzzyT/Sonoff-NSPanel-with-ESPHome/discussions) tab.\
